  ...
  const contactInfo = [
    {
      ...
      text: "hello@surfe.com",
      href: "mailto:hello@surfe.com",
    },
    {
  ...
  return (
    <footer className="bg-[#0F0F11] relative h-fit rounded-3xl overflow-hidden m-8">
      <div className="max-w-7xl mx-auto p-14 z-40 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white text-3xl font-bold">Surfe</span>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0">
          ...
          <p className="text-center md:text-left text-gray-300">
            &copy; {new Date().getFullYear()} Surfe. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <div className="lg:flex hidden h-[30rem] -mt-52 -mb-36">
        <TextHoverEffect text="Surfe" className="z-50" />
      </div>
